...
import fr.sivarth.sbm.block.custom.trees.PalmTree;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> PINEAPPLE_LEAVES = registerBlock("pineapple_leaves", () -> new LeavesBlock(AbstractBlock.Properties.of(Material.LEAVES).strength(0.2f, 0.2f).sound(SoundType.GRASS).noOcclusion().requiresCorrectToolForDrops()));
    ...
    public static final RegistryObject<Block> SAS_BLOCK = registerBlock("sas_block", () -> new Block(AbstractBlock.Properties.of(Material.METAL).strength(4.0f, 3.5f).harvestTool(ToolType.PICKAXE).harvestLevel(2).sound(SoundType.METAL).requiresCorrectToolForDrops()));

    public static final RegistryObject<Block> CORAL_PLANKS = registerBlock("coral_planks", () -> new Block(AbstractBlock.Properties.of(Material.WOOD).strength(3.2f, 2.5f).harvestTool(ToolType.HOE).harvestLevel(0).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> CORAL_PLANKS_STAIRS = registerBlock("coral_planks_stairs", () -> new StairsBlock(() -> CORAL_PLANKS.get().defaultBlockState(), AbstractBlock.Properties.of(Material.WOOD).strength(3.2f, 2.5f).harvestTool(ToolType.AXE).harvestLevel(0).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> CORAL_PLANKS_FENCE = registerBlock("coral_planks_fence", () -> new FenceBlock(AbstractBlock.Properties.of(Material.WOOD).strength(3.2f, 2.5f).harvestTool(ToolType.AXE).harvestLevel(0).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> CORAL_PLANKS_FENCE_GATE = registerBlock("coral_planks_fence_gate", () -> new FenceGateBlock(AbstractBlock.Properties.of(Material.WOOD).strength(3.2f, 2.5f).harvestTool(ToolType.AXE).harvestLevel(0).sound(SoundType.WOOD)));

    public static final RegistryObject<Block> ROUND_WINDOW = registerBlock("round_window", () -> new RoundWindowBlock(AbstractBlock.Properties.of(Material.METAL).strength(4.1f, 3.5f).harvestTool(ToolType.PICKAXE).harvestLevel(1).sound(SoundType.METAL).noOcclusion().requiresCorrectToolForDrops()));
    ...
    public static final RegistryObject<Block> PALM_LOG = registerBlock("palm_log", () -> new RotatedPillarBlock(AbstractBlock.Properties.of(Material.WOOD)));
    public static final RegistryObject<Block> PALM_LEAVES = registerBlock("palm_leaves", () -> new LeavesBlock(AbstractBlock.Properties.of(Material.LEAVES).strength(0.2f, 0.2f).sound(SoundType.GRASS).noOcclusion().requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> PALM_SAPLING = registerBlock("palm_sapling",() -> new SaplingBlock(new PalmTree(), AbstractBlock.Properties.copy(Blocks.DEAD_BUSH)));
